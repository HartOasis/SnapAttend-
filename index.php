...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($employeeId) || empty($password)) {
        ...
        // Get employee by ID
        $employee = getEmployeeByCode($employeeId, $password);
...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            ...
            <h2 class="animate__animated animate__fadeInDown">Employee Login</h2>
            <p class="animate__animated animate__fadeInUp">Access your attendance dashboard</p>
        </div>
        ...
        <div class="login-form">
            ...
            <div class="admin-link animate__animated animate__fadeIn" style="animation-delay: 0.5s;">
